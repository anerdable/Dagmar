...
const themedays: readonly Themeday[] = [
  {
    id: 0,
    title: 'Internationella kvinnodagen',
    date: new Date('2021-03-08'),
    category: DateType.FixedDate,
  },
  {
    id: 1,
  ...
  {
    id: 2,
    title: 'Theravada New Year',
    date: new Date('2021-04-27'),
    category: DateType.Moveable,
  },
  {
    id: 3,
    title: 'Regnbågsfamiljernas dag',
    date: new Date('2021-05-02'),
    category: DateType.Moveable,
  },
  {
    id: 4,
    title: 'Teckenspråkets dag',
  ...
  {
    id: 6,
    title: 'Norges nationaldag',
    date: new Date('2021-05-17'),
    category: DateType.FixedDate,
  },
  {
    id: 7,
    title: 'Internationella dagen för världens ursprungsfolk',
    date: new Date('2021-08-09'),
    category: DateType.FixedDate,
  },
  {
    id: 8,
    title: 'Jämställdhetsdagen',
    date: new Date('2021-08-26'),
    category: DateType.FixedDate,
  },
  {
    id: 9,
    title: 'Programmerarens dag',
  ...
  },
  {
    id: 10,
    title: 'Måndagsdagen',
    date: new Date('2021-08-09T00:00'),
    category: DateType.FixedDate,
  },
  {
    id: 11,
    title: 'Tisdagsdagen',
    date: new Date('2021-08-10T00:00'),
    category: DateType.FixedDate,
  },
  {
    id: 12,
    title: 'Fredagsdagen',
    date: new Date('2021-08-13T00:00'),
    category: DateType.FixedDate,
  },
  {
    id: 13,
    title: 'Söndagsdagen',
    date: new Date('2021-08-15T00:00'),
    category: DateType.FixedDate,
  },
  {
    id: 14,
    title: '!! Söndagen innan dagen !!',
    date: new Date('2021-08-08T00:00'),
    category: DateType.FixedDate,
  },
  {
    id: 15,
    title: '!! Måndagen efter !!',
    date: new Date('2021-08-16T00:00'),
    category: DateType.FixedDate,
  },
];
